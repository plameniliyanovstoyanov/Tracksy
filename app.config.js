...
module.exports = {
  expo: {
    ...
    extra: {
      ...
      SUPABASE_URL: process.env.EXPO_PUBLIC_SUPABASE_URL || "https://ztlyoketftsciylvfq.supabase.co",
      ...
      EXPO_PUBLIC_SUPABASE_URL: process.env.EXPO_PUBLIC_SUPABASE_URL || "https://ztlyoketftsciylvfq.supabase.co",
